...
async def run_inventory_task(
    ...
    dry_run: bool = False,
    orphan_collector: OrphanCollector | None = None,
) -> dict[str, Any]:
    """
    ...
    match_results, unmatched = nb.match(
        tool_records=tool_data,
        netbox_objects=applicable,
        match_keys=match_keys,
    )

    # Feed unmatched records to orphan collector if provided
    if orphan_collector and unmatched:
        orphan_collector.add(
