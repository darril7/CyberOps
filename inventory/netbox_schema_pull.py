...
=====================
Connects to NetBox, pulls all SOC custom fields and choice sets, and generates:
...
# ══════════════════════════════════════════════════════════════════
# MAPPING — same logic as before, lives here in Python
# This gets serialised to JSON and embedded in the HTML
# ══════════════════════════════════════════════════════════════════
...
MAPPING = {
    ...
    "product_to_cis_app_benchmark": {
        "apache": "CIS-APACHE", "nginx": "CIS-NGINX", "iis": "CIS-IIS",
        "mysql": "CIS-MYSQL", "mssql": "CIS-MSSQL", "postgresql": "CIS-PGSQL",
        "oracle": "CIS-ORACLE", "exchange": "CIS-EXCHANGE", "postfix": "NA",
    },
    "product_to_sigma": {
        "apache": ["linux","apache"], "nginx": ["linux","nginx"],
        "iis": ["windows","iis"], "mysql": ["linux","mysql"],
        "mssql": ["windows","mssql"], "postgresql": ["linux","postgresql"],
        "oracle": ["linux","oracle"], "exchange": ["windows","exchange"],
        "postfix": ["linux","postfix"],
    },
    "server_roles": {
        "SRV-DC":     {"label":"Domain Controller","device_function":"SRV-DC","cis_app_benchmark":"CIS-AD","sigma_product":["windows","active_directory"],"sigma_log_categories":["process_creation","authentication","active_directory"],"product_overrides":False},
        "SRV-DB":     {"label":"Database Server","device_function":"SRV-DB","cis_app_benchmark":"OTHER","sigma_product":[],"sigma_log_categories":["process_creation","authentication","database","file_change"],"product_overrides":True},
        "SRV-WEB":    {"label":"Web Server","device_function":"SRV-WEB","cis_app_benchmark":"OTHER","sigma_product":[],"sigma_log_categories":["process_creation","authentication","web","network_connection"],"product_overrides":True},
        "SRV-APP":    {"label":"Business Application","device_function":"SRV-APP","cis_app_benchmark":"CUSTOM","sigma_product":["custom"],"sigma_log_categories":["process_creation","authentication","custom"],"product_overrides":False,"flag_log_path":True},
        "SRV-MAIL":   {"label":"Mail Server","device_function":"SRV-MAIL","cis_app_benchmark":"OTHER","sigma_product":[],"sigma_log_categories":["process_creation","authentication","email"],"product_overrides":True},
        "SRV-FILE":   {"label":"File Server","device_function":"SRV-FILE","cis_app_benchmark":"NA","sigma_product":["windows","samba"],"sigma_log_categories":["process_creation","authentication","file_change"],"product_overrides":False},
        "SRV-PROXY":  {"label":"Proxy / Reverse Proxy","device_function":"SRV-PROXY","cis_app_benchmark":"NA","sigma_product":["linux","squid"],"sigma_log_categories":["process_creation","authentication","network_connection","web"],"product_overrides":False},
        "SRV-MON":    {"label":"Monitoring / SIEM","device_function":"SRV-MON","cis_app_benchmark":"NA","sigma_product":["linux","elastic","wazuh"],"sigma_log_categories":["process_creation","authentication"],"product_overrides":False},
        "SRV-BACKUP": {"label":"Backup Server","device_function":"SRV-BACKUP","cis_app_benchmark":"NA","sigma_product":["linux"],"sigma_log_categories":["process_creation","authentication","file_change"],"product_overrides":False},
        "OTHER":      {"label":"Not Listed","device_function":"OTHER","cis_app_benchmark":"OTHER","sigma_product":["custom"],"sigma_log_categories":["process_creation","authentication"],"product_overrides":False,"import_status":"REVIEW NEEDED"},
    },
    "workstation_roles": {
        "WRK-STD": {"label":"Standard User","device_function":"WRK-STD","cis_app_benchmark":"NA","sigma_product":["windows"],"sigma_log_categories":["process_creation","authentication"]},
        "WRK-DEV": {"label":"Developer","device_function":"WRK-DEV","cis_app_benchmark":"NA","sigma_product":["windows"],"sigma_log_categories":["process_creation","authentication","network_connection"]},
        "WRK-PAW": {"label":"Privileged Access (PAW)","device_function":"WRK-PAW","cis_app_benchmark":"NA","sigma_product":["windows"],"sigma_log_categories":["process_creation","authentication","file_change","registry","powershell"]},
    },
    "workstation_default": "WRK-STD",
    "appliance_roles": {
        "APL-FW":    {"label":"Firewall","device_function":"APL-FW","cis_os_benchmark":"VENDOR-OS","cis_app_benchmark":"VENDOR-GUIDE","sigma_product":["fortinet"],"sigma_log_categories":["firewall","network_connection"],"log_collector":"SYSLOG"},
        "APL-SW":    {"label":"Switch","device_function":"APL-SW","cis_os_benchmark":"VENDOR-OS","cis_app_benchmark":"VENDOR-GUIDE","sigma_product":["cisco"],"sigma_log_categories":["network_connection"],"log_collector":"SYSLOG"},
        "APL-WAF":   {"label":"WAF","device_function":"APL-WAF","cis_os_benchmark":"VENDOR-OS","cis_app_benchmark":"VENDOR-GUIDE","sigma_product":["nginx"],"sigma_log_categories":["web","network_connection"],"log_collector":"SYSLOG"},
        "APL-IDS":   {"label":"IDS / IPS","device_function":"APL-IDS","cis_os_benchmark":"VENDOR-OS","cis_app_benchmark":"VENDOR-GUIDE","sigma_product":["suricata"],"sigma_log_categories":["network_connection"],"log_collector":"SYSLOG"},
        "APL-PROXY": {"label":"Proxy Appliance","device_function":"APL-PROXY","cis_os_benchmark":"VENDOR-OS","cis_app_benchmark":"VENDOR-GUIDE","sigma_product":["squid"],"sigma_log_categories":["web","network_connection"],"log_collector":"SYSLOG"},
        "OTHER":     {"label":"Not Listed","device_function":"OTHER","cis_os_benchmark":"VENDOR-OS","cis_app_benchmark":"VENDOR-GUIDE","sigma_product":["custom"],"sigma_log_categories":["network_connection"],"log_collector":"SYSLOG","import_status":"REVIEW NEEDED"},
    },
    "escalation": {
        "fields": ["internet_facing","sensitive_data"],
        "values": ["Yes"],
        "overrides": {"cis_os_profile": "L2"},
...
def build_html(schema: dict) -> str:
